...
#         resampled_pix_spot_values[dy+1:ny_spot+dy+1,dx+1:nx_spot+dx+1] += w11*pix_spot_values
        ...
        pix_prod_bl = [[x * w00 for a in pix_spot_list] for x in a] #bottom left
        pix_prod_br = [[x * w10 for a in pix_spot_list] for x in a] #bottom right
        pix_prod_tl = [[x * w01 for a in pix_spot_list] for x in a] #top left
        pix_prod_tr = [[x * w11 for a in pix_spot_list] for x in a] #top right
