...
class SpotGridPSF(PSF):
    ...
    def _xypix_interp(self, ispec, wavelength):
        ...
        #print statements to see array sizes
        print(resampled_pix_spot_values[dy:ny_spot+dy,dx:nx_spot+dx].shape)
        print(resampled_pix_spot_values[dy+1:ny_spot+dy+1,dx:nx_spot+dx].shape)
        print(resampled_pix_spot_values[dy:ny_spot+dy,dx+1:nx_spot+dx+1].shape)
        print(resampled_pix_spot_values[dy+1:ny_spot+dy+1,dx+1:nx_spot+dx+1].shape)
