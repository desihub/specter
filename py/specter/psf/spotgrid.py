...
class SpotGridPSF(PSF):
    ...
    def _xypix_interp(self, ispec, wavelength):
        ...
        resampled_pix_spot_values[dy:ny_spot+dy,dx:nx_spot+dx]         = w00*pix_spot_values + resampled_pix_spot_values
        resampled_pix_spot_values[dy+1:ny_spot+dy+1,dx:nx_spot+dx]     = w10*pix_spot_values + resampled_pix_spot_values
        resampled_pix_spot_values[dy:ny_spot+dy,dx+1:nx_spot+dx+1]     = w01*pix_spot_values + resampled_pix_spot_values
        resampled_pix_spot_values[dy+1:ny_spot+dy+1,dx+1:nx_spot+dx+1] = w11*pix_spot_values + resampled_pix_spot_values
