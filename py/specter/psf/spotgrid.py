...
#         resampled_pix_spot_values[dy+1:ny_spot+dy+1,dx+1:nx_spot+dx+1] += w11*pix_spot_values
        ...
        pix_prod_bl = [[a * w00 for a in pix_spot_list] for b in pix_spot_list[0]] #bottom left
        pix_prod_br = [[a * w10 for a in pix_spot_list] for b in pix_spot_list[0]] #bottom right
        pix_prod_tl = [[a * w01 for a in pix_spot_list] for b in pix_spot_list[0]] #top left
        pix_prod_tr = [[a * w11 for a in pix_spot_list] for b in pix_spot_list[0]] #top right
