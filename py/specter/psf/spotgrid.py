...
#         resampled_pix_spot_values[dy+1:ny_spot+dy+1,dx+1:nx_spot+dx+1] += w11*pix_spot_values
        ...
        pix_prod_bl = [x * w00 for x in pix_spot_list for y in pix_spot_list] #bottom left
        pix_prod_br = [x * w10 for x in pix_spot_list for y in pix_spot_list] #bottom right
        pix_prod_tl = [x * w01 for x in pix_spot_list for y in pix_spot_list] #top left
        pix_prod_tr = [x * w11 for x in pix_spot_list for y in pix_spot_list] #top right
